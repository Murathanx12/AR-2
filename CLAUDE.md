...
- Direction convention across both paths: obstacle on right half → pass it on the LEFT → `omega_sign = -1`; obstacle on left half → pass it on the RIGHT → `omega_sign = +1`.
